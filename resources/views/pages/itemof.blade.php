	  ...
	  <div class="row">
	    ...
	    <div class="col-sm-4">
	      <div class="panel panel-success">
            ...
            <div class="col-md-6">
              <a href=""><button class="btn btn-default"><span class="glyphicons glyphicons-edit"></span> Edit</button></a>
              <a href=""><button class="btn btn-default"><span class="glyphicons glyphicons-delete"></span> Delete</button></a>
            </div>
          </div>
